    ...
    <div>
      <div className="flex space-x-5">
        ...
        <div className=" flex-1 lg:border-l px-5 relative">
          ...
          {/* top section */}
          <div className="lg:mt-10  mt-5 absolute top-0 left-4 right-4 flex flex-col-reverse gap-4 md:flex-row items-center justify-between">
            <div className=""><SearchBar /></div>
            <div className=""><Toolbar /></div>
          </div>

          {/* list of company */}
          <div className="lg:mt-28 mt-36 flex justify-between">
