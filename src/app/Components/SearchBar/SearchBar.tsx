...
const SearchBar = () => {
    ...
    return (
        <div className="relative md:w-[400px] w-[300px]  product_search_input">
            ...
            {/* shortcut hint */}
            <div
                className="absolute top-[5px] right-1.5 text-[0.6rem]  border border-gray-100 p-[8px] bg-blue-400 rounded-md text-white">
